...
还以扔硬币为例，扔10次有3次正面朝上，7次背面朝上，可以由此记录得到一个beta的先验分布：f(H; 3, 7)。接下来再扔8次，前7次正面朝上，1次背面朝上，后验概率仍然是一个beta分布，只是参数发生了变化：f(H; 10, 8)
![Beta分布概率密度函数](0710MachineLearning1/img16.jpg)
